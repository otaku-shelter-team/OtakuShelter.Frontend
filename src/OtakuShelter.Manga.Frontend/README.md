...
Also has error with kotlinx-serialization-runtime-js.
App want find .map file, but cannot find it.
You need go to `/node_modules/kotlinx-serialization-runtime-js` 
and rename \
`kotlinx-serialization-runtime-js.meta.js` to `kotlinx-serialization-runtime-js.map.js`
